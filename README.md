...
| Area | What you get |
|---|---|
| 📷 Check a book | **The main screen for parents.** In a shop, snap the cover (or type the title, author or ISBN) and get a plain verdict: "✓ within Jenna's limit" (0–2 peppers), "⚠ the gray area" (3) or "✕ explicit" (4–5), with the reason, tags and summary. Books you already have answer at once; others are looked up (Open Library), rated on the spot and kept under **Looked up**. The AI reads the cover (vision models such as `gpt-4o-mini`, Claude or Gemini); Android phones read the ISBN barcode themselves. |
...
| 🌶️ Pepper scale | Books are rated **0–5 peppers**: 0 No Romance, 1 Sweet Romance, 2 Mild / Closed Door (*Jenna's limit*), 3 Steamy / Heavy Tension (the *gray area*), 4 Explicit / Open Door, 5 Very Explicit / Erotica. Each rating says why in a few words, and level-3 cards show a **⚠ Gray area** tag with the reason (for example "Heavy innuendo, on-page foreplay"). **What do the peppers mean?** in the Library gives the full descriptions and examples. Kid accounts have a **Most peppers allowed** limit (age groups start at 0, 1, 2, 3 or no limit) and a one-click **Strict family preset** (up to 2 peppers, nothing explicit or unrated). When the rating rules change, older AI ratings can be re-rated in one click and stay visible meanwhile. |
